...
RSpec.describe Api::V1::VisitsController, type: :routing do
  describe 'routing' do
    ...
    it 'routes to #show' do
      expect(get: '/api/v1/visits/1').to route_to('api/v1/visits#show', id: '1')
    end
    ...
    it 'routes to #update via PUT' do
      expect(put: '/api/v1/visits/1').to route_to('api/v1/visits#update', id: '1')
    end

    it 'routes to #update via PATCH' do
      expect(patch: '/api/v1/visits/1').to route_to('api/v1/visits#update', id: '1')
    end

    it 'routes to #destroy' do
      expect(delete: '/api/v1/visits/1').to route_to('api/v1/visits#destroy', id: '1')
    end
  end
end
